 ...
 */
final class Version20220331162812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD weight VARCHAR(128) DEFAULT NULL');
        $this->addSql('ALTER TABLE patient ADD CONSTRAINT FK_1ADAD7EB40369CAB FOREIGN KEY (vet_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_1ADAD7EB40369CAB ON patient (vet_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient DROP FOREIGN KEY FK_1ADAD7EB40369CAB');
        $this->addSql('DROP INDEX IDX_1ADAD7EB40369CAB ON patient');
        $this->addSql('ALTER TABLE patient DROP weight, CHANGE species species VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE race race VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE color color VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE eyes eyes VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE info info LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE gender gender VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
