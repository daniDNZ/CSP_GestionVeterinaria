 ...
 */
final class Version20220401091409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD race_id INT DEFAULT NULL, DROP race');
        $this->addSql('ALTER TABLE patient ADD CONSTRAINT FK_1ADAD7EB6E59D40D FOREIGN KEY (race_id) REFERENCES race (id)');
        $this->addSql('CREATE INDEX IDX_1ADAD7EB6E59D40D ON patient (race_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient DROP FOREIGN KEY FK_1ADAD7EB6E59D40D');
        $this->addSql('DROP INDEX IDX_1ADAD7EB6E59D40D ON patient');
        $this->addSql('ALTER TABLE patient ADD race VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP race_id, CHANGE color color VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE eyes eyes VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE info info LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE gender gender VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE weight weight VARCHAR(128) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
