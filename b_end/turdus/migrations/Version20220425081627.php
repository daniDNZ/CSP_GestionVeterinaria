 ...
 */
final class Version20220425081627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX CODE_UNIQUE ON product');
        $this->addSql('ALTER TABLE visit ADD cart JSON DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX CODE_UNIQUE ON product (code)');
